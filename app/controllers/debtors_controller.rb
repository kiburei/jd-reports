class DebtorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @debtor.save
        format.html { redirect_to debtors_path, notice: 'Debtor was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @debtor.update(debtor_params)
        format.html { redirect_to debtors_url, notice: 'Debtor was successfully updated.' }
  ...
  def add_bebt
    @debtor.update(debt: @debtor.debt + params[:debt])
  ...
  private
    ...
    def debtor_params
      params.require(:debtor).permit(:f_name, :l_name, :debt, :items)
    end
end
